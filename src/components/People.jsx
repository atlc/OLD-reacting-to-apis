                    ...
                    <div key={person.id} className="card text-center">
                        <div className="card-body">
                            ...
                            <p className="card-text">
                                <small className="text-muted">Hair color {person.hair_color}</small>
                            </p>
                            <p className="card-text">
                                <small className="text-muted">Eye color: {person.eye_color}</small>
                            </p>
                            <a href={person.url} className="btn btn-danger">
                                See my full info here:
                            </a>
                        </div>
                    </div>
                ))}
