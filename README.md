...
The API we will start with is the [Studio Ghibli API](https://api-ghibli.herokuapp.com/). If you visit that website, you will be able to see what a traditional API explorer looks like. Spend a few minutes familiarizing yourself with the website, and see if you can determine what **_endpoints_** are exposed in the API.
...
_Hint: Don't forget your keys!_
...
_Hint: your fetch method from Phase One does not need to change in order to complete this section. Instead, consider toggling a property in state with the button click._
